...
declare module Backbone {
    ...
    interface PersistenceOptions {
        ...
        error?: (modelOrCollection?: any, jqxhr?: any, options?: any) => void;
    }
    ...
    class Collection<TModel extends Model> extends ModelBase {
        ...
        **/
        ...
        fetch(options?: CollectionFetchOptions): any;
   ...
   interface ViewOptions<TModel extends Model> {
	...
	class NativeView<TModel extends Model> extends View<TModel> {

	}

	// SYNC
	function sync(method: string, model: Model, options?: any): any;
	function ajax(options?: any): any;
